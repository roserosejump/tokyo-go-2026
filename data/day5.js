const DAY5 = {
  ...
  items: [
...

    {
      ...
      trs: '🚶 步行 [5min]',
      tasks: [
        "Kiddy Land 新宿 (10:30-20:30)：買卡比！",
        'Shiro (11-21)：香水、唇釉',
        'Aiam (11-21)：香水',
      ],
      mapUrl: 'https://maps.google.com/?q=東京都新宿区新宿3-23-17+オカダヤビル+キデイランド新宿店',
    },

    {
      ...
      trs: '🚃 JR山手線 (內回) [5min]',
      desc:
        "★ 預計搭乘 11:00 班次 (預計 11:05 抵達原宿站)\n" +
        "・前3班備案：10:45、10:50、10:55\n" +
        "・後3班備案：11:05、11:10、11:15",
    },
